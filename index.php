...
<title>SAFAR | Car Rental Portal</title>
<!--Bootstrap -->
...
<!-- /Switcher -->  
<marquee style="background-color:red; colsor:black; padding:5px 0px 5px 0px; font-weight: bold; ">Hi there! Nice to see you. We have a 10% promo code for new customers!...</marquee>      
<!--Header-->
...
<div class="car-info-box" style="height: 250px;"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image"></a>
<ul>
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>90+</h2>
